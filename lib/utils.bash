...
# NOTE: You might want to remove this if ki is not hosted on GitHub releases.
...
list_all_versions() {
  ...
  # Change this function if ki has other means of determining installable versions.
  list_github_tags
}
...
download_release() {
  ...
  # TODO: Adapt the release URL convention for ki
...
install_version() {
  ...
  (
    ...
    # TODO: Asert ki executable exists.
    local tool_cmd
